  ...
  return (
    <form action="" method="GET" className="flex gap-5 mt-3 items-center bg-white p-2 rounded-lg">
      ...
      <div className="relative  text-gray-500 focus-within:text-gray-900 ">
        ...
        <input type="text" id="default-search" className="block w-full max-w-xs pr-4 pl-12 py-2 text-sm font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none leading-relaxed" placeholder="Activité" />
      </div>
      <div className="relative  text-gray-500 focus-within:text-gray-900 ">
        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
