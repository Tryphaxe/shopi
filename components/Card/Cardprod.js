        ...
        <div className="relative w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link href="#" className="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
