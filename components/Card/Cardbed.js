    ...
    return (
        <div className="max-w-80 min-w-64 h-min bg-white border border-gray-200 rounded-2xl shadow overflow-hidden relative">
            ...
            <form className="p-3">
                ...
                <div className='mt-3 grid grid-cols-2 w-full'>
                    <div>
                    ...
                    <div className='flex items-end justify-end gap-x-3'>
                        <button className='rounded-md px-3 py-2 bg-gray-100 text-black'><i className="fa-solid fa-pen"></i></button>
                        <button className='rounded-md px-3 py-2 bg-red-800 text-white'><i className="fa-solid fa-trash-can"></i></button>
                    </div>
                </div>
            </form>
        </div >
