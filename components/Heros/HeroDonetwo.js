            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-14 text-center">
                    ...
                    <div className="flex flex-col justify-center md:flex-row gap-5 max-w-lg mx-auto md:max-w-2xl lg:max-w-full">
                        <a href="javascript:;" className="cursor-pointer bg-orange-600 py-3 px-6 rounded-full flex items-center justify-center text-sm font-semibold text-white transition-all duration-500 focus:outline-none hover:bg-orange-700">
                            Get started
                        </a>
                        <a href="javascript:;" className="cursor-pointer bg-orange-50 py-3 px-6 rounded-full flex items-center justify-center  text-sm font-semibold text-orange-600 transition-all duration-500 focus:outline-none hover:bg-orange-100">
                            Learn more
                        </a>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-lg mx-auto md:max-w-2xl lg:max-w-full">
                    ...
                    <div className="relative w-full h-auto">
                        <div className="bg-orange-500 rounded-2xl p-5  xl:p-8 h-full">
                            <div className="block">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="relative w-full h-auto">
                        <div className="bg-orange-800 rounded-2xl p-5 xl:p-8 h-full">
                            <div className="block">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
