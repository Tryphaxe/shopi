...
function page() {
    ...
    const handleSubmit = (e) => {
        ...
        router.push("/checkout"); // Rediriger après le traitement
    };
        ...
        <section
            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10">
                <div className="grid grid-cols-12">
                    <div
                        className="col-span-12 xl:col-span-8 lg:pr-8 p-8 w-full max-xl:max-w-3xl max-xl:mx-auto">
                        <div className="flex items-center justify-between pb-8 border-b border-gray-300">
                            <h2 className="font-manrope font-bold text-3xl leading-10 text-black">Panier</h2>
                            <h2 className="font-manrope font-bold text-xl leading-8 text-gray-600">3 Items</h2>
                        </div>
                        <div className="grid grid-cols-12 mt-8 max-md:hidden pb-6 border-b border-gray-200">
                            <div className="col-span-12 md:col-span-7">
                                <p className="font-normal text-lg leading-8 text-gray-400">Détails produits</p>
                            </div>
                        ...
                        <div className="flex items-center justify-end mt-8">
                            <button
                                className="flex items-center px-5 py-3 rounded-full gap-2 border-none outline-0 group font-semibold text-lg leading-8 text-orange-600 shadow-sm shadow-transparent transition-all duration-500 hover:text-orange-700">
                                Ajouter code coupon
                                <svg className="transition-all duration-500 group-hover:translate-x-2" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                    ...
                                    <path
                                        ...
                                        stroke="#ff9677" strokeWidth="1.6" strokeLinecap="round" />
                                </svg>
                            </button>
                        </div>
                    </div>
                    <div
                        className=" col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-8">
                        ...
                        <div className="mt-8">
                            ...
                            <form  onSubmit={handleSubmit}>
                                <label className="flex  items-center mb-1.5 text-gray-600 text-sm font-medium">Expédition
                                </label>
                                ...
                                <button className="w-full text-center bg-orange-600 rounded-xl py-2 px-6 font-semibold text-lg text-white transition-all duration-500 hover:bg-orange-700">
                                    Checkout
                                </button>
                            </form>
                        </div>
