...
export default function Home() {
  return (
    <div className="">
      ...
      {/* INSCRIPTION */}
      <div className="relative w-5/6 mx-auto lg:py-8 lg:px-20 p-3 rounded-2xl bg-gradient-to-r from-[#1b5c16] to-[#73ad54] flex items-center justify-between flex-col lg:flex-row my-12">
